...
family = Family('khadija', 'matin', 'ripa', 'maisha', 'raiyan')
print(f'my name:{family.my_name}, father name:{family.father_name}, mother name:{family.mother_name}, sister name:{family.sister_name}, brother name:{family.brother_name}')
